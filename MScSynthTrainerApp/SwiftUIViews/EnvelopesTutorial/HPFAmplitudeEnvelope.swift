...
class HPFAmpEnvConductor: ObservableObject, KeyboardDelegate {
    var osc = Oscillator()
    ...
    @Published var data = HPFAmpEnvData() {
        didSet {
...
struct HPFAmpEnvView: View {
    @StateObject var conductor = HPFAmpEnvConductor()
...
struct HPFAmpEnv_Previews: PreviewProvider {
